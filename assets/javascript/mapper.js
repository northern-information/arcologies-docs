function redraw() {
  ...
  for(i=0; i<mapper.cells.length; i++){
    ...
    $(c).html('<img src="https://northern-information.github.io/arcologies-docs/assets/images/structures-svg/arcologies-glyphs_' + cell[2] + '.svg" class="glyph" />');
  }
}
...
function buildCells(mapper) {
  ...
  for ( h = 1; h < mapper.height + 1; h++) {
    ...
    for ( w = 1; w < mapper.width + 1; w++) {
      ...
      'px;">' + 
      '<img src="https://northern-information.github.io/arcologies-docs/assets/images/structures-svg/arcologies-glyphs_diamond.svg" class="diamond"/>' +
      '</div>';
      counter++;
    }
    out += '</div>';
